...
class KnowledgeDataset(torch.utils.data.Dataset):
    def __init__(self, mode, fold, val=True, data_dir=None):
        ...
        if val:
            ...
            train_data, test_data = load_explain_split_data(fold, True, data_dir)
