...
from transe.models.models import SentenceTransE, SentenceTransformerEncoder, RelationEncoder
...
class TestSentenceTransE(unittest.TestCase):
    def setUp(self):
        ...
        self.model = SentenceTransE(sentence_encoder, relation_encoder, sentence_embedding_dim, num_relation, mapped_embedding_dim)
