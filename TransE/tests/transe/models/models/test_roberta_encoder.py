...
from transe.models.models import RobertaEncoder

class TestRobertaEncoder(unittest.TestCase):
    def setUp(self):
        self.encoder = RobertaEncoder(model_name='paraphrase-distilroberta-base-v1')
